  ...
  return (
    <div className="bg-teal-900">
      <footer className="footer footer-horizontal footer-center  text-white p-10 container mx-auto">
        ...
        <nav>
          <h1 className="text-2xl font-semibold py-2">Social Link</h1>

          <div className="grid grid-flow-col gap-4">
            <a className="bg-white text-black p-2 rounded-full flex items-center justify-center">
              <svg
        ...
        <div className="w-full border-t border-teal-700 pt-6 mt-6 flex flex-col md:flex-row justify-between items-center gap-4">
